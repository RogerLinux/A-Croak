...
void swap(vector<int>::iterator it1, vector<int>::iterator it2){
        if(it1 == it2)return;
        int tmp = *it1;
...
void pairSort(vector<string>::iterator str_begin, vector<string>::iterator str_end, vector<int>::iterator num_begin, vector<int>::iterator num_end){
        ...
        string p_str = *str_begin;
        int p_n = *(num_end - 1);
        vector<int>::iterator it_head, it_tail;
        vector<string>::iterator str_head, str_tail;
